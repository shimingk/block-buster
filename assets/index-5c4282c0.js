 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(t,n){this.name=t,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const n=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(n)){const s=new Du;if(this.instancesDeferred.set(n,s),this.isInitialized(n)||this.shouldAutoInitialize())try{const i=this.getOrInitializeService({instanceIdentifier:n});i&&s.resolve(i)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(t){var n;const s=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),i=(n=t==null?void 0:t.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(s)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:s})}catch(r){if(i)return null;throw r}else{if(i)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(Pu(t))try{this.getOrInitializeService({instanceIdentifier:Ot})}catch{}for(const[n,s]of this.instancesDeferred.entries()){const i=this.normalizeInstanceIdentifier(n);try{const r=this.getOrInitializeService({instanceIdentifier:i});s.resolve(r)}catch{}}}}clearInstance(t=Ot){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...t.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=Ot){return this.instances.has(t)}getOptions(t=Ot){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:n={}}=t,s=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(s))throw Error(`${this.name}(${s}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const i=this.getOrInitializeService({instanceIdentifier:s,options:n});for(const[r,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(r);s===a&&o.resolve(i)}return i}onInit(t,n){var s;const i=this.normalizeInstanceIdentifier(n),r=(s=this.onInitCallbacks.get(i))!==null&&s!==void 0?s:new Set;r.add(t),this.onInitCallbacks.set(i,r);const o=this.instances.get(i);return o&&t(o,i),()=>{r.delete(t)}}invokeOnInitCallbacks(t,n){const s=this.onInitCallbacks.get(n);if(s)for(const i of s)try{i(t,n)}catch{}}getOrInitializeService({instanceIdentifier:t,options:n={}}){let s=this.instances.get(t);if(!s&&this.component&&(s=this.component.instanceFactory(this.container,{instanceIdentifier:Lu(t),options:n}),this.instances.set(t,s),this.instancesOptions.set(t,n),this.invokeOnInitCallbacks(s,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,s)}catch{}return s||null}normalizeInstanceIdentifier(t=Ot){return this.component?this.component.multipleInstances?t:Ot:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function Lu(e){return e===Ot?void 0:e}function Pu(e){return e.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rh=Ch;function Fo(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const s=Object.assign({name:js,automaticDataCollectionEnabled:!1},t),i=s.name;if(typeof i!="string"||!i)throw bt.create("bad-app-name",{appName:String(i)});if(n||(n=_u()),!n)throw bt.create("no-options");const r=xn.get(i);if(r){if(Vs(n,r.options)&&Vs(s,r.config))return r;throw bt.create("duplicate-app",{appName:i})}const o=new Fu(i);for(const c of Hs.values())o.addComponent(c);const a=new xh(n,s,o);return xn.set(i,a),a}function $h(e=js){const t=xn.get(e);if(!t&&e===js)return Fo();if(!t)throw bt.create("no-app",{appName:e});return t}function te(e,t,n){var s;let i=(s=_h[e])!==null&&s!==void 0?s:e;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${t}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Kt.warn(a.join(" "));return}Rn(new Le(`${i}-version`,()=>({library:i,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mh="firebase-heartbeat-database",Oh=1,Pe="firebase-heartbeat-store";let Cs=null;function Vo(){return Cs||(Cs=Yu(Mh,Oh,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(Pe)}}}).catch(e=>{throw bt.create("idb-open",{originalErrorMessage:e.message})})),Cs}async function Lh(e){try{return(await Vo()).transaction(Pe).objectStore(Pe).get(Uo(e))}catch(t){if(t instanceof me)Kt.warn(t.message);else{const n=bt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Kt.warn(n.message)}}}async function br(e,t){try{const s=(await Vo()).transaction(Pe,"readwrite");return await s.objectStore(Pe).put(t,Uo(e)),s.done}catch(n){if(n instanceof me)Kt.warn(n.message);else{const s=bt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Kt.warn(s.message)}}}function Uo(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function T(e="Unexpected state"){const t=`FIRESTORE (${we}) INTERNAL ASSERTION FAILED: `+e;throw Et(t),new Error(t)}function R(e,t){e||T()}function b(e,t){return e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function za(e){var t,n;return((n=(((t=e==null?void 0:e.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function Ga(e){const t=e.mapValue.fields.__previous_value__;return za(t)?Ga(t):t}function Ke(e){const t=Nt(e.mapValue.fields.__local_write_time__.timestampValue);return new V(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Od=new B(w.comparator);function It(){return Od}const pc=new B(w.comparator);function ke(...e){let t=pc;for(const n of e)t=t.insert(n.key,n);return t}function gc(e){let t=pc;return e.forEach((n,s)=>t=t.insert(n,s.overlayedDocument)),t}function Ft(){return Oe()}function mc(){return Oe()}function Oe(){return new Ie(e=>e.toString(),(e,t)=>e.isEqual(t))}const Ld=new B(w.comparator),Pd=new U(w.comparator);function _(...e){let t=Pd;for(const n of e)t=t.add(n);return t}const Fd=new U(x);function yc(){return Fd}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pf{constructor(){this.overlays=new B(w.comparator),this.ss=new Map}getOverlay(t,n){return p.resolve(this.overlays.get(n))}getOverlays(t,n){const s=Ft();return p.forEach(n,i=>this.getOverlay(t,i).next(r=>{r!==null&&s.set(i,r)})).next(()=>s)}saveOverlays(t,n,s){return s.forEach((i,r)=>{this.ce(t,n,r)}),p.resolve()}removeOverlaysForBatchId(t,n,s){const i=this.ss.get(s);return i!==void 0&&(i.forEach(r=>this.overlays=this.overlays.remove(r)),this.ss.delete(s)),p.resolve()}getOverlaysForCollection(t,n,s){const i=Ft(),r=n.length+1,o=new w(n.child("")),a=this.overlays.getIteratorFrom(o);for(;a.hasNext();){const c=a.getNext().value,u=c.getKey();if(!n.isPrefixOf(u.path))break;u.path.length===r&&c.largestBatchId>s&&i.set(c.getKey(),c)}return p.resolve(i)}getOverlaysForCollectionGroup(t,n,s,i){let r=new B((u,h)=>u-h);const o=this.overlays.getIterator();for(;o.hasNext();){const u=o.getNext().value;if(u.getKey().getCollectionGroup()===n&&u.largestBatchId>s){let h=r.get(u.largestBatchId);h===null&&(h=Ft(),r=r.insert(u.largestBatchId,h)),h.set(u.getKey(),u)}}const a=Ft(),c=r.getIterator();for(;c.hasNext()&&(c.getNext().value.forEach((u,h)=>a.set(u,h)),!(a.size()>=i)););return p.resolve(a)}ce(t,n,s){const i=this.overlays.get(s.key);if(i!==null){const o=this.ss.get(i.largestBatchId).delete(s.key);this.ss.set(i.largestBatchId,o)}this.overlays=this.overlays.insert(s.key,new rf(n,s));let r=this.ss.get(n);r===void 0&&(r=_(),this.ss.set(n,r)),this.ss.set(n,r.add(s.key))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gf{constructor(t,n){this.indexManager=t,this.referenceDelegate=n,this.mutationQueue=[],this.ys=1,this.ps=new U(j.os)}checkEmpty(t){return p.resolve(this.mutationQueue.length===0)}addMutationBatch(t,n,s,i){const r=this.ys;this.ys++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new sf(r,n,s,i);this.mutationQueue.push(o);for(const a of i)this.ps=this.ps.add(new j(a.key,r)),this.indexManager.addToCollectionParentIndex(t,a.key.path.popLast());return p.resolve(o)}lookupMutationBatch(t,n){return p.resolve(this.Is(n))}getNextMutationBatchAfterBatchId(t,n){const s=n+1,i=this.Ts(s),r=i<0?0:i;return p.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return p.resolve(this.mutationQueue.length===0?-1:this.ys-1)}getAllMutationBatches(t){return p.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,n){const s=new j(n,0),i=new j(n,Number.POSITIVE_INFINITY),r=[];return this.ps.forEachInRange([s,i],o=>{const a=this.Is(o.gs);r.push(a)}),p.resolve(r)}getAllMutationBatchesAffectingDocumentKeys(t,n){let s=new U(x);return n.forEach(i=>{const r=new j(i,0),o=new j(i,Number.POSITIVE_INFINITY);this.ps.forEachInRange([r,o],a=>{s=s.add(a.gs)})}),p.resolve(this.Es(s))}getAllMutationBatchesAffectingQuery(t,n){const s=n.path,i=s.length+1;let r=s;w.isDocumentKey(r)||(r=r.child(""));const o=new j(new w(r),0);let a=new U(x);return this.ps.forEachWhile(c=>{const u=c.key.path;return!!s.isPrefixOf(u)&&(u.length===i&&(a=a.add(c.gs)),!0)},o),p.resolve(this.Es(a))}Es(t){const n=[];return t.forEach(s=>{const i=this.Is(s);i!==null&&n.push(i)}),n}removeMutationBatch(t,n){R(this.As(n.batchId,"removed")===0),this.mutationQueue.shift();let s=this.ps;return p.forEach(n.mutations,i=>{const r=new j(i.key,n.batchId);return s=s.delete(r),this.referenceDelegate.markPotentiallyOrphaned(t,i.key)}).next(()=>{this.ps=s})}Pn(t){}containsKey(t,n){const s=new j(n,0),i=this.ps.firstAfterOrEqual(s);return p.resolve(n.isEqual(i&&i.key))}performConsistencyCheck(t){return this.mutationQueue.length,p.resolve()}As(t,n){return this.Ts(t)}Ts(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}Is(t){const n=this.Ts(t);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W="WebChannelConnection";class Mf extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const n=t.ssl?"https":"http";this.co=n+"://"+t.host,this.ao="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get ho(){return!1}lo(t,n,s,i,r){const o=Ls(),a=this.fo(t,n);v("RestConnection",`Sending RPC '${t}' ${o}:`,a,s);const c={};return this._o(c,i,r),this.wo(t,a,c,s).then(u=>(v("RestConnection",`Received RPC '${t}' ${o}: `,u),u),u=>{throw ni("RestConnection",`RPC '${t}' ${o} failed with error: `,u,"url: ",a,"request:",s),u})}mo(t,n,s,i,r,o){return this.lo(t,n,s,i,r)}_o(t,n,s){t["X-Goog-Api-Client"]="gl-js/ fire/"+we,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((i,r)=>t[r]=i),s&&s.headers.forEach((i,r)=>t[r]=i)}fo(t,n){const s=Rf[t];return`${this.co}/v1/${n}:${s}`}}{constructor(t){super(t),this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams}wo(t,n,s,i){const r=Ls();return new Promise((o,a)=>{const c=new zl;c.setWithCredentials(!0),c.listenOnce(jl.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case Ms.NO_ERROR:const h=c.getResponseJson();v(W,`XHR for RPC '${t}' ${r} received:`,JSON.stringify(h)),o(h);break;case Ms.TIMEOUT:v(W,`RPC '${t}' ${r} timed out`),a(new m(f.DEADLINE_EXCEEDED,"Request time out"));break;case Ms.HTTP_ERROR:const l=c.getStatus();if(v(W,`RPC '${t}' ${r} failed with status:`,l,"response text:",c.getResponseText()),l>0){let d=c.getResponseJson();Array.isArray(d)&&(d=d[0]);const g=d==null?void 0:d.error;if(g&&g.status&&g.message){const A=function(E){const N=E.toLowerCase().replace(/_/g,"-");return Object.values(f).indexOf(N)>=0?N:f.UNKNOWN}(g.status);a(new m(A,g.message))}else a(new m(f.UNKNOWN,"Server responded with status "+c.getStatus()))}else a(new m(f.UNAVAILABLE,"Connection failed."));break;default:T()}}finally{v(W,`RPC '${t}' ${r} completed.`)}});const u=JSON.stringify(i);v(W,`RPC '${t}' ${r} sending request:`,i),c.send(n,"POST",u,s,15)})}yo(t,n,s){const i=Ls(),r=[this.co,"/","google.firestore.v1.Firestore","/",t,"/channel"],o=Bl(),a=ql(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(c.xmlHttpFactory=new Kl({})),this._o(c.initMessageHeaders,n,s),c.encodeInitMessageHeaders=!0;const u=r.join("");v(W,`Creating RPC '${t}' stream ${i}: ${u}`,c);const h=o.createWebChannel(u,c);let l=!1,d=!1;const g=new $f({Yr:E=>{d?v(W,`Not sending because RPC '${t}' stream ${i} is closed:`,E):(l||(v(W,`Opening RPC '${t}' stream ${i} transport.`),h.open(),l=!0),v(W,`RPC '${t}' stream ${i} sending:`,E),h.send(E))},Zr:()=>h.close()}),A=(E,N,nt)=>{E.listen(N,it=>{try{nt(it)}catch(pt){setTimeout(()=>{throw pt},0)}})};return A(h,Tn.EventType.OPEN,()=>{d||v(W,`RPC '${t}' stream ${i} transport opened.`)}),A(h,Tn.EventType.CLOSE,()=>{d||(d=!0,v(W,`RPC '${t}' stream ${i} transport closed`),g.oo())}),A(h,Tn.EventType.ERROR,E=>{d||(d=!0,ni(W,`RPC '${t}' stream ${i} transport errored:`,E),g.oo(new m(f.UNAVAILABLE,"The operation could not be completed")))}),A(h,Tn.EventType.MESSAGE,E=>{var N;if(!d){const nt=E.data[0];R(!!nt);const it=nt,pt=it.error||((N=it[0])===null||N===void 0?void 0:N.error);if(pt){v(W,`RPC '${t}' stream ${i} received error:`,pt);const Se=pt.status;let be=function(mu){const wr=L[mu];if(wr!==void 0)return fc(wr)}(Se),vr=pt.message;be===void 0&&(be=f.INTERNAL,vr="Unknown error status: "+Se+" with message "+pt.message),d=!0,g.oo(new m(be,vr)),h.close()}else v(W,`RPC '${t}' stream ${i} received:`,nt),g.uo(nt)}}),A(a,Hl.STAT_EVENT,E=>{E.stat===Ur.PROXY?v(W,`RPC '${t}' stream ${i} detected buffering proxy`):E.stat===Ur.NOPROXY&&v(W,`RPC '${t}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{g.ro()},0),g}}function Ps(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.cu?(Et(n),this.cu=!1):v("OnlineStateTracker",n)}du(){this.uu!==null&&(this.uu.cancel(),this.uu=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zc{constructor(t){this.observer=t,this.muted=!1}next(t){this.observer.next&&this.vc(this.observer.next,t)}error(t){this.observer.error?this.vc(this.observer.error,t):Et("Uncaught Error in snapshot listener:",t.toString())}bc(){this.muted=!0}vc(t,n){this.muted||setTimeout(()=>{this.muted||t(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot{constructor(t,n,s){this.converter=n,this._key=s,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new _t(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new ot(this.firestore,t,this._key)}}class $t{constructor(t,n,s){this.converter=n,this._query=s,this.type="query",this.firestore=t}withConverter(t){return new $t(this.firestore,t,this._query)}}class _t extends $t{constructor(t,n,s){super(t,n,Hi(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new ot(this.firestore,null,new w(t))}withConverter(t){return new _t(this.firestore,t,this._path)}}function ir(e,t,...n){if(e=Ht(e),Qc("collection","path",t),e instanceof Ts){const s=$.fromString(t,...n);return yo(s),new _t(e,null,s)}{if(!(e instanceof ot||e instanceof _t))throw new m(f.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=e._path.child($.fromString(t,...n));return yo(s),new _t(e.firestore,null,s)}}function Cp(e,t,...n){if(e=Ht(e),arguments.length===1&&(t=Ha.R()),Qc("doc","path",t),e instanceof Ts){const s=$.fromString(t,...n);return mo(s),new ot(e,null,new w(s))}{if(!(e instanceof ot||e instanceof _t))throw new m(f.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=e._path.child($.fromString(t,...n));return mo(s),new ot(e.firestore,e instanceof _t?e.converter:null,new w(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xe{constructor(t,n){this.hasPendingWrites=t,this.fromCache=n}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class cu extends su{constructor(t,n,s,i,r,o){super(t,n,s,i,o),this._firestore=t,this._firestoreImpl=t,this.metadata=r}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const n=new Dn(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(n,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,n={}){if(this._document){const s=this._document.data.field(hr("DocumentSnapshot.get",t));if(s!==null)return this._userDataWriter.convertValue(s,n.serverTimestamps)}}}class Dn extends cu{data(t={}){return super.data(t)}}class uu{constructor(t,n,s,i){this._firestore=t,this._userDataWriter=n,this._snapshot=i,this.metadata=new xe(i.hasPendingWrites,i.fromCache),this.query=s}get docs(){const t=[];return this.forEach(n=>t.push(n)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,n){this._snapshot.docs.forEach(s=>{t.call(n,new Dn(this._firestore,this._userDataWriter,s.key,s,new xe(this._snapshot.mutatedKeys.has(s.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const n=!!t.includeMetadataChanges;if(n&&this._snapshot.excludesMetadataChanges)throw new m(f.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===n||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let r=0;return s._snapshot.docChanges.map(o=>{const a=new Dn(s._firestore,s._userDataWriter,o.doc.key,o.doc,new xe(s._snapshot.mutatedKeys.has(o.doc.key),s._snapshot.fromCache),s.query.converter);return o.doc,{type:"added",doc:a,oldIndex:-1,newIndex:r++}})}{let r=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(o=>i||o.type!==3).map(o=>{const a=new Dn(s._firestore,s._userDataWriter,o.doc.key,o.doc,new xe(s._snapshot.mutatedKeys.has(o.doc.key),s._snapshot.fromCache),s.query.converter);let c=-1,u=-1;return o.type!==0&&(c=r.indexOf(o.doc.key),r=r.delete(o.doc.key)),o.type!==1&&(r=r.add(o.doc),u=r.indexOf(o.doc.key)),{type:qp(o.type),doc:a,oldIndex:c,newIndex:u}})}}(this,n),this._cachedChangesIncludeMetadataChanges=n),this._cachedChanges}}function qp(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return T()}}class gr extends Up{constructor(t){super(),this.firestore=t}convertBytes(t){return new de(t)}convertReference(t){const n=this.convertDocumentKey(t,this.firestore._databaseId);return new ot(this.firestore,null,n)}}function jp(e){e=qt(e,$t);const t=qt(e.firestore,We),n=rr(t),s=new gr(t);return iu(e._query),Ap(n,e._query).then(i=>new uu(t,s,e,i))}function Hp(e,t){const n=qt(e.firestore,We),s=Cp(e),i=Bp(e.converter,t);return zp(n,[Rp(Jc(e.firestore),"addDoc",s._key,i,e.converter!==null,{}).toMutation(s._key,vt.exists(!1))]).then(()=>s)}function Kp(e,...t){var n,s,i;e=Ht(e);let r={includeMetadataChanges:!1},o=0;typeof t[o]!="object"||wo(t[o])||(r=t[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges};if(wo(t[o])){const l=t[o];t[o]=(n=l.next)===null||n===void 0?void 0:n.bind(l),t[o+1]=(s=l.error)===null||s===void 0?void 0:s.bind(l),t[o+2]=(i=l.complete)===null||i===void 0?void 0:i.bind(l)}let c,u,h;if(e instanceof ot)u=qt(e.firestore,We),h=Hi(e._key.path),c={next:l=>{t[o]&&t[o](Gp(u,e,l))},error:t[o+1],complete:t[o+2]};else{const l=qt(e,$t);u=qt(l.firestore,We),h=l._query;const d=new gr(u);c={next:g=>{t[o]&&t[o](new uu(u,d,l,g))},error:t[o+1],complete:t[o+2]},iu(e._query)}return function(l,d,g,A){const E=new zc(A),N=new Vc(d,E,g);return l.asyncQueue.enqueueAndForget(async()=>Pc(await gi(l),N)),()=>{E.bc(),l.asyncQueue.enqueueAndForget(async()=>Fc(await gi(l),N))}}(rr(u),h,a,c)}function zp(e,t){return function(n,s){const i=new Ct;return n.asyncQueue.enqueueAndForget(async()=>ap(await Ip(n),s,i)),i.promise}(rr(e),t)}function Gp(e,t,n){const s=n.docs.get(t._key),i=new gr(e);return new cu(e,i,t._key,s,new xe(n.hasPendingWrites,n.fromCache),t.converter)}(function(e,t=!0){(function(n){we=n})(Rh),Rn(new Le("firestore",(n,{instanceIdentifier:s,options:i})=>{const r=n.getProvider("app").getImmediate(),o=new We(new Wl(n.getProvider("auth-internal")),new Zl(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new m(f.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new He(a.options.projectId,c)}(r,s),r);return i=Object.assign({useFetchStreams:t},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),te(Br,"3.9.0",e),te(Br,"3.9.0","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Fs;const Qn=window,fe=Qn.trustedTypes,Io=fe?fe.createPolicy("lit-html",{createHTML:e=>e}):void 0,At=`lit$${(Math.random()+"").slice(9)}$`,hu="?"+At,Qp=`<${hu}>`,pe=document,Xe=(e="")=>pe.createComment(e),Ye=e=>e===null||typeof e!="object"&&typeof e!="function",lu=Array.isArray,Wp=e=>lu(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",_e=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ao=/-->/g,So=/>/g,Mt=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),bo=/'/g,Co=/"/g,du=/^(?:script|style|textarea|title)$/i,Xp=e=>(t,...n)=>({_$litType$:e,strings:t,values:n}),mi=Xp(1),Je=Symbol.for("lit-noChange"),H=Symbol.for("lit-nothing"),_o=new WeakMap,ie=pe.createTreeWalker(pe,129,null,!1),Yp=(e,t)=>{const n=e.length-1,s=[];let i,r=t===2?"<svg>":"",o=_e;for(let c=0;c<n;c++){const u=e[c];let h,l,d=-1,g=0;for(;g<u.length&&(o.lastIndex=g,l=o.exec(u),l!==null);)g=o.lastIndex,o===_e?l[1]==="!--"?o=Ao:l[1]!==void 0?o=So:l[2]!==void 0?(du.test(l[2])&&(i=RegExp("</"+l[2],"g")),o=Mt):l[3]!==void 0&&(o=Mt):o===Mt?l[0]===">"?(o=i??_e,d=-1):l[1]===void 0?d=-2:(d=o.lastIndex-l[2].length,h=l[1],o=l[3]===void 0?Mt:l[3]==='"'?Co:bo):o===Co||o===bo?o=Mt:o===Ao||o===So?o=_e:(o=Mt,i=void 0);const A=o===Mt&&e[c+1].startsWith("/>")?" ":"";r+=o===_e?u+Qp:d>=0?(s.push(h),u.slice(0,d)+"$lit$"+u.slice(d)+At+A):u+At+(d===-2?(s.push(void 0),c):A)}const a=r+(e[n]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Io!==void 0?Io.createHTML(a):a,s]};class Ze{constructor({strings:t,_$litType$:n},s){let i;this.parts=[];let r=0,o=0;const a=t.length-1,c=this.parts,[u,h]=Yp(t,n);if(this.el=Ze.createElement(u,s),ie.currentNode=this.el.content,n===2){const l=this.el.content,d=l.firstChild;d.remove(),l.append(...d.childNodes)}for(;(i=ie.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes()){const l=[];for(const d of i.getAttributeNames())if(d.endsWith("$lit$")||d.startsWith(At)){const g=h[o++];if(l.push(d),g!==void 0){const A=i.getAttribute(g.toLowerCase()+"$lit$").split(At),E=/([.?@])?(.*)/.exec(g);c.push({type:1,index:r,name:E[2],strings:A,ctor:E[1]==="."?Zp:E[1]==="?"?eg:E[1]==="@"?ng:Is})}else c.push({type:6,index:r})}for(const d of l)i.removeAttribute(d)}if(du.test(i.tagName)){const l=i.textContent.split(At),d=l.length-1;if(d>0){i.textContent=fe?fe.emptyScript:"";for(let g=0;g<d;g++)i.append(l[g],Xe()),ie.nextNode(),c.push({type:2,index:++r});i.append(l[d],Xe())}}}else if(i.nodeType===8)if(i.data===hu)c.push({type:2,index:r});else{let l=-1;for(;(l=i.data.indexOf(At,l+1))!==-1;)c.push({type:7,index:r}),l+=At.length-1}r++}}static createElement(t,n){const s=pe.createElement("template");return s.innerHTML=t,s}}function ge(e,t,n=e,s){var i,r,o,a;if(t===Je)return t;let c=s!==void 0?(i=n._$Co)===null||i===void 0?void 0:i[s]:n._$Cl;const u=Ye(t)?void 0:t._$litDirective$;return(c==null?void 0:c.constructor)!==u&&((r=c==null?void 0:c._$AO)===null||r===void 0||r.call(c,!1),u===void 0?c=void 0:(c=new u(e),c._$AT(e,n,s)),s!==void 0?((o=(a=n)._$Co)!==null&&o!==void 0?o:a._$Co=[])[s]=c:n._$Cl=c),c!==void 0&&(t=ge(e,c._$AS(e,t.values),c,s)),t}class Jp{constructor(t,n){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=n}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var n;const{el:{content:s},parts:i}=this._$AD,r=((n=t==null?void 0:t.creationScope)!==null&&n!==void 0?n:pe).importNode(s,!0);ie.currentNode=r;let o=ie.nextNode(),a=0,c=0,u=i[0];for(;u!==void 0;){if(a===u.index){let h;u.type===2?h=new mn(o,o.nextSibling,this,t):u.type===1?h=new u.ctor(o,u.name,u.strings,this,t):u.type===6&&(h=new sg(o,this,t)),this.u.push(h),u=i[++c]}a!==(u==null?void 0:u.index)&&(o=ie.nextNode(),a++)}return r}p(t){let n=0;for(const s of this.u)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,n),n+=s.strings.length-2):s._$AI(t[n])),n++}}class mn{constructor(t,n,s,i){var r;this.type=2,this._$AH=H,this._$AN=void 0,this._$AA=t,this._$AB=n,this._$AM=s,this.options=i,this._$Cm=(r=i==null?void 0:i.isConnected)===null||r===void 0||r}get _$AU(){var t,n;return(n=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&n!==void 0?n:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const n=this._$AM;return n!==void 0&&t.nodeType===11&&(t=n.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,n=this){t=ge(this,t,n),Ye(t)?t===H||t==null||t===""?(this._$AH!==H&&this._$AR(),this._$AH=H):t!==this._$AH&&t!==Je&&this.g(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Wp(t)?this.k(t):this.g(t)}O(t,n=this._$AB){return this._$AA.parentNode.insertBefore(t,n)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==H&&Ye(this._$AH)?this._$AA.nextSibling.data=t:this.T(pe.createTextNode(t)),this._$AH=t}$(t){var n;const{values:s,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=Ze.createElement(i.h,this.options)),i);if(((n=this._$AH)===null||n===void 0?void 0:n._$AD)===r)this._$AH.p(s);else{const o=new Jp(r,this),a=o.v(this.options);o.p(s),this.T(a),this._$AH=o}}_$AC(t){let n=_o.get(t.strings);return n===void 0&&_o.set(t.strings,n=new Ze(t)),n}k(t){lu(this._$AH)||(this._$AH=[],this._$AR());const n=this._$AH;let s,i=0;for(const r of t)i===n.length?n.push(s=new mn(this.O(Xe()),this.O(Xe()),this,this.options)):s=n[i],s._$AI(r),i++;i<n.length&&(this._$AR(s&&s._$AB.nextSibling,i),n.length=i)}_$AR(t=this._$AA.nextSibling,n){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,n);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var n;this._$AM===void 0&&(this._$Cm=t,(n=this._$AP)===null||n===void 0||n.call(this,t))}}class Is{constructor(t,n,s,i,r){this.type=1,this._$AH=H,this._$AN=void 0,this.element=t,this.name=n,this._$AM=i,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=H}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,n=this,s,i){const r=this.strings;let o=!1;if(r===void 0)t=ge(this,t,n,0),o=!Ye(t)||t!==this._$AH&&t!==Je,o&&(this._$AH=t);else{const a=t;let c,u;for(t=r[0],c=0;c<r.length-1;c++)u=ge(this,a[s+c],n,c),u===Je&&(u=this._$AH[c]),o||(o=!Ye(u)||u!==this._$AH[c]),u===H?t=H:t!==H&&(t+=(u??"")+r[c+1]),this._$AH[c]=u}o&&!i&&this.j(t)}j(t){t===H?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Zp extends Is{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===H?void 0:t}}const tg=fe?fe.emptyScript:"";class eg extends Is{constructor(){super(...arguments),this.type=4}j(t){t&&t!==H?this.element.setAttribute(this.name,tg):this.element.removeAttribute(this.name)}}class ng extends Is{constructor(t,n,s,i,r){super(t,n,s,i,r),this.type=5}_$AI(t,n=this){var s;if((t=(s=ge(this,t,n,0))!==null&&s!==void 0?s:H)===Je)return;const i=this._$AH,r=t===H&&i!==H||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,o=t!==H&&(i===H||r);r&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var n,s;typeof this._$AH=="function"?this._$AH.call((s=(n=this.options)===null||n===void 0?void 0:n.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}}class sg{constructor(t,n,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=n,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){ge(this,t)}}const Do=Qn.litHtmlPolyfillSupport;Do==null||Do(Ze,mn),((Fs=Qn.litHtmlVersions)!==null&&Fs!==void 0?Fs:Qn.litHtmlVersions=[]).push("2.6.1");const mr=(e,t,n)=>{var s,i;const r=(s=n==null?void 0:n.renderBefore)!==null&&s!==void 0?s:t;let o=r._$litPart$;if(o===void 0){const a=(i=n==null?void 0:n.renderBefore)!==null&&i!==void 0?i:null;r._$litPart$=o=new mn(t.insertBefore(Xe(),a),a,void 0,n??{})}return o._$AI(e),o},ig={apiKey:"AIzaSyBONiC9wxzJpjjZWaK5NKLBUtLxCqq0MII",authDomain:"block-buster-db.firebaseapp.com",projectId:"block-buster-db",storageBucket:"block-buster-db.appspot.com",messagingSenderId:"543350152958",appId:"1:543350152958:web:1c94323a5101398e180faf"},rg=Fo(ig),yr=Dp(rg);let Nn=[];const og=ir(yr,"leaderboard");async function ag(e){console.log("username is: "+e),e===""&&(e="anonymous"),console.log("Sending "+e+"'s score!");try{const t=await Hp(ir(yr,"leaderboard"),{time:Date.now(),score:yn,user:e});console.log("Document written with ID: ",t.id)}catch(t){console.error("Error adding document: ",t)}}async function cg(){Nn=[],(await jp(Fp(og,Vp("score","desc")))).forEach(t=>{let n=t.data();Nn.push(n)}),console.log(Nn),mr(fu(),document.body)}function ug(e){e.key=="Enter"&&(ag(e.target.value),e.target.value="",document.getElementById("input-container").remove(),mr(fu(),document.body))}function hg(){return mi`<div id="input-container">
      <h2>Hit [Enter] after entering your name</h2>
      <input type="text" @keydown=${ug} placeholder="NAME"/>
    </div>`}function fu(){return mi`
    <div id="score-container">
      <h1>Leaderboard</h1>
      <h2>Score : Player</h2>
      ${Nn.map(e=>mi`<div class="score">${e.score} : ${e.user}</div>`)}
    </div>`}Kp(ir(yr,"leaderboard"),e=>{console.log("snap",e),cg()},e=>{console.error(e)});let gt,q,C,yt=1e3,Vt=500;const pu=3,gu=5;let jt=!0;const No=Math.round(yt/gu-5),ko=Math.round(Vt*1/5/pu-5);let rt,yn=0;window.setup=()=>{createCanvas(yt,Vt),world.gravity=-25,gt=createSprite(width/2,height,250,50),gt.shapeColor=color("turquoise"),q=createSprite(width/2,height/2,150,50),q.shapeColor=color("red"),C=new Sprite,C.diameter=25,C.shapeColor=color("yellow"),rt=new Group,generateBlocks()};window.generateBlocks=()=>{for(let e=0;e<pu;e++)for(let t=0;t<gu;t++){let n=createSprite(t*(No+2)+100,e*(ko+2),No,ko);rt.add(n)}};window.checkBall=()=>{C.velocity.x===0&&C.velocity.y===0&&(C.velocity.x=5,C.velocity.y=5),C.y-C.diameter/2<=0&&(C.velocity.y=-C.velocity.y),C.y+C.diameter/2>=Vt&&(jt=!1,C.visible=!1,console.log("end")),(C.x-C.diameter/2<=0||C.x+C.diameter/2>=yt)&&(C.velocity.x=-C.velocity.x),rt.forEach((e,t)=>{C.collides(e)&&(C.velocity.y=5,C.velocity.x=-C.velocity.x,e.remove(t,1),yn++,rt.length===0&&(jt=!1))}),C.collides(gt)&&(C.velocity.x=-C.velocity.x,C.velocity.y=-5),C.collides(q)&&(C.velocity.y>0?C.velocity.y=5:C.velocity.y=-5,C.velocity.x=-C.velocity.x)};window.displayScore=()=>{fill("beige"),textAlign(CENTER),textSize(25),text(`Score: ${yn}`,yt/2,150)};window.endScreen=e=>{e==="You Win!"?(fill("springgreen"),e+="  🤩"):fill("magenta"),textAlign(CENTER),textSize(35),text(e,yt/2,Vt/2),text("Play again: [Space]",yt/2,Vt/2+55),text(`Score: ${yn}`,yt/2,Vt/2-55),text("Save Score: [Tab]",yt/2,Vt/2+110)};window.keyPressed=()=>{keyCode===32&&!jt&&(jt=!0,gt.visible=!0,q.visible=!0,C.visible=!0,C.x=width/2,C.y=height/2,rt.removeAll(),yn=0,generateBlocks()),keyCode===9&&(!jt&&rt.length!=0||rt.length===0)&&mr(hg(),document.body)};window.draw=()=>{background("black"),C.visible=!0,gt.velocity.x=(mouseX-gt.position.x)*.25,gt.velocity.y=0,rt.length===0&&(C.visible=!1,q.visible=!1,q.velocity.x=0,rt.visible=!1,endScreen("You Win!")),!jt&&rt.length!=0&&(C.visible=!1,q.visible=!1,q.velocity.x=0,rt.visible=!1,gt.visible=!1,endScreen("GAME OVER 😜")),jt&&(q.visible=!0,C.visible=!0,rt.visible=!0,displayScore(),checkBall(),q.collider="kinematic",q.velocity.x===0?q.velocity.x=5:(q.x===0&&(q.velocity.x=-q.velocity.x),q.x===yt&&(q.velocity.x=-q.velocity.x)),rt.collider="kinematic",gt.collider="kinematic",drawSprites())};
